...
def ret_llama_results(question_prompt):
	sequences = pipeline(question_prompt, do_sample=True, top_k=10, num_return_sequences=1, eos_token_id=tokenizer.eos_token_id, max_length=1000, return_full_text=False)
	return sequences
...
def prep_evaluation(dval, mcq_list, with_ts = 0, model='gpt4'):
	...
	ts_str = ts2str(fix_ts(dval['series']))
	index = dval['uuid']
